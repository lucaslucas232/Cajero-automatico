...
Public Class ADMINISTRAR_USUARIOS
    ...
    Dim obj_usuario As New CLS_CAJERO_USUARIOS
    Dim n As Integer
    Dim ini As Integer
    Dim id As Integer
    ...
    Private Sub administrar_usuarios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        BTN_NUEVO.Select()
        BTN_MODIFICAR.Enabled = False
        BTN_ELIMINAR.Enabled = False

        ini = 0
        ActualizarTabla(Me.DGV1, "usuarios", "", "APELLIDO") 'tabla usuarios ordenado por apellido        ' Label9.Text = n
        pinta_fila(ini)
    ...
    Private Sub BTN_AGREGAR_Click(sender As Object, e As EventArgs) Handles BTN_AGREGAR.Click
        Try
            If ValidarDatos() Then
                If obj_usuario.AgregaUsuario(TXT_NOMBRE.Text, TXT_APELLIDO.Text, TXT_TELEFONO.Text, TXT_correo.Text, TXT_CEDULA.Text, DateTimePicker1.Value, TXT_NUMERO_CUENTA.Text, txt_USUARIO.Text, cmb_tipo.Text, TXT_CONTRASEÑA.Text, PictureBox1) = True Then
    ...
    Private Sub DGV1_MouseClick(sender As Object, e As MouseEventArgs) Handles DGV1.MouseClick
        ...
        Else
            ...
            txt_USUARIO.Text = ObtenerCampo(Me.DGV1, 8)
            TXT_CONTRASEÑA.Text = ObtenerCampo(Me.DGV1, 10)
            TXT_CEDULA.Text = ObtenerCampo(Me.DGV1, 5)
            TXT_correo.Text = ObtenerCampo(Me.DGV1, 4)
            TXT_TELEFONO.Text = ObtenerCampo(Me.DGV1, 3)
            cmb_tipo.Text = ObtenerCampo(Me.DGV1, 9)
            TXT_NUMERO_CUENTA.Text = ObtenerCampo(Me.DGV1, 7)

            id = ObtenerCampo(Me.DGV1, 0)
            'PictureBox1.Image = ObtenerCampo(Me.DGV1, 11)
    ...
    Private Sub BTN_MODIFICAR_Click(sender As Object, e As EventArgs) Handles BTN_MODIFICAR.Click
        Try
            ...
            If i = MsgBoxResult.Yes Then
                ...
                If ValidarDatos() Then
                    If obj_usuario.Modificausuario(TXT_NOMBRE.Text,
                                                   TXT_APELLIDO.Text,
                                                   Val(TXT_TELEFONO.Text),
                                                   TXT_correo.Text,
                                                   TXT_CEDULA.Text,
                                                   DateTimePicker1.Value,
                                                  Val(TXT_NUMERO_CUENTA.Text),
                                                   txt_USUARIO.Text,
                                                   cmb_tipo.Text,
                                                   TXT_CONTRASEÑA.Text,
                                                   PictureBox1,
    ...
    Private Sub ADMINISTRAR_USUARIOS_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        MDI_CAJERO.muestra()
    End Sub
